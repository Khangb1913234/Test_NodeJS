...
router.post("/register", validate.validateName, validate.validateEmail, validate.validatePassword, accounts.register)
router.post("/login", accounts.login)
router.put("/update/:id", upload.single("avatar"), auth, validate.validateName, validate.validateEmail, validate.validatePassword, accounts.update)   
router.delete("/delete/:id", auth, accounts.delete)
router.post("/forgotpassword", accounts.forgotPassword)
router.put("/resetpassword", validate.validatePassword, accounts.resetPassword)
